            ...
            return(
                ...
                <div className="container-fluid h-100 content-section">
                    <div className="row home-inner-section">
                        ...
                        <div className="col-xl-9 col-lg-7 col-md-12 col-sm-9 theme-section">
                            <div className="row">
                                <div className="col-sm-12 py-3 theme-header">
                                    <h5><i className="fa fa-paint-brush"></i> Choose your Color</h5>
                                </div>
                            </div>
                            <div className="row mt-5">
                                <div className="col-xl-4 col-6 mb-3">
                                    <div>
                                        <img src="assets/images/blue-theme.jpg" alt="" className="img-fluid img-thumbnail" />
                                    </div>
                                    <div className="text-center mt-3">
                                        <button className="btn btn-theme">Select Theme</button>
                                    </div>
                                </div>
                                <div className="col-xl-4 col-6 mb-3">
                                    <div>
                                        <img src="assets/images/black-theme.jpg" alt="" className="img-fluid img-thumbnail" />
                                    </div>
                                    <div className="text-center mt-3">
                                        <button className="btn btn-theme">Select Theme</button>
                                    </div>
